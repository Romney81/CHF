...
_magic_number = 10
_modified_time = 1428349724.935031
_enable_loop = True
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        for field in form:
            ...
            __M_writer('\n    \t\t\t</div>\n    \t\t</div>\n')
        __M_writer('    \t\t<button type="submit" class="btn custom">Sign In</button>\n            <p class="forgot">Forgot your password? Click <a href="/password_reset/">Here</a></p>\n    \t</form>\n\n</div>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"source_encoding": "ascii", "line_map": {"64": 24, "35": 1, "70": 64, "40": 29, "46": 3, "59": 17, "53": 3, "54": 10, "55": 11, "56": 13, "57": 13, "58": 16, "27": 0, "60": 18, "61": 18, "62": 20, "63": 20}, "uri": "index.loginform.html", "filename": "/Users/scottromney/SiteOne/shop/templates/index.loginform.html"}
__M_END_METADATA
"""
