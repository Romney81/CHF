"""
Django settings for SiteOne project.
...
SECRET_KEY = 'xw8fjv&a^@c(l_w2aglrah6xxix)(7qvw57t_8gv#@*@3&$bep'
...
WSGI_APPLICATION = 'SiteOne.wsgi.application'
